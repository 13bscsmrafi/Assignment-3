...
$p->control_type = $CONTROL_RADIOBUTTONS;		// Control type; $CONTROL_RADIOBUTTONS or $CONTROL_COMBOBOX
$p->add_value("1", "PHP Guestbook");	// You may include the optional URL parameter to create a link
$p->add_value("2", "PHP Poll");
$p->add_value("3", "PHP Image Gallery");
$p->add_value("4", "PHP Ratings");
$VALID_POLLS["3"] = $p;	
